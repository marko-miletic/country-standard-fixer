...
for dataframe in import_files.get_dataframes_and_file_names():
    dataframes_correction.correction(dataframe[0], countries_set, codes_set_alpha3, codes_set_alpha2, country_code_combinations)
    export_files.export(dataframe[0], dataframe[1], format="csv")
